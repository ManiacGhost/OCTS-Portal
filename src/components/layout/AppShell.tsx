        ...
        <header className="sticky top-0 z-30 bg-white border-b border-slate-200">
          <div className="flex items-center justify-between gap-4 px-4 sm:px-6 py-3">
            ...
            <div className="relative" ref={menuRef}>
              ...
              >
                <div className={`w-10 h-10 rounded-xl ${user.avatarBg || 'bg-rose-600'} text-white flex items-center justify-center font-bold text-base shrink-0`}>
                  {user.name.charAt(0)}
                </div>
              ...
              {menuOpen && (
                <div className="absolute right-0 mt-2.5 w-80 bg-white border border-slate-200 rounded-2xl shadow-2xl overflow-hidden z-40">
                  <div className="flex items-center gap-3.5 px-5 py-4 border-b border-slate-100">
                    <div className={`w-12 h-12 rounded-xl ${user.avatarBg || 'bg-rose-600'} text-white flex items-center justify-center font-bold text-lg shrink-0`}>
                      {user.name.charAt(0)}
                    </div>
                  ...
                  <button
                    ...
                    className="w-full flex items-center gap-3 px-5 py-3.5 text-base font-semibold text-rose-700 hover:bg-rose-50 transition"
                  >
